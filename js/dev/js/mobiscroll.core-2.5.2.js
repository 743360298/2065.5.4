    ...
    function Scroller(elem, settings) {
        ...
        */
        that.change = function (manual) {
            ...
            if (s.display == 'inline') {
                ...
                $('#newTime').html(formatHeader(v));
                

                        var oldDate = formatHeader(v);
                        console.log(oldDate);
                        $('#birthday').html(oldDate);
                        ...
                        var y = oldDate.substring(0,4)
                        console.log(y);
                        var m = oldDate.substring(5,7)
                        console.log(m);
                        var d = oldDate.substring(8,10)
                        console.log(d);
                            ...
                            if (m == 1 && d > 31) {$('#zodiac').text(  "Huh?")} 
                            if (m == 2 && d >=19 || m == 3 && d <=20) {$('#zodiac').text( "双鱼座")} 
                            if (m == 2 && d > 29) {$('#zodiac').text( "Say what?")} 
                            if (m == 3 && d >=21 || m == 4 && d <=19) {$('#zodiac').text( "白羊座")} 
                            if (m == 3 && d > 31) {$('#zodiac').text( "OK. Whatever.")} 
                            if (m == 4 && d >=20 || m == 5 && d <=20) {$('#zodiac').text( "金牛座")} 
                            if (m == 4 && d > 30) {$('#zodiac').text( "I'm soooo sorry!")} 
                            if (m == 5 && d >=21 || m == 6 && d <=21) {$('#zodiac').text( "双子座")} 
                            if (m == 5 && d > 31) {$('#zodiac').text( "Umm ... no.")} 
                            if (m == 6 && d >=22 || m == 7 && d <=22) {$('#zodiac').text( "巨蟹座")} 
                            if (m == 6 && d > 30) {$('#zodiac').text( "Sorry.")} 
                            if (m == 7 && d >=23 || m == 8 && d <=22) {$('#zodiac').text( "狮子座")} 
                            if (m == 7 && d > 31) {$('#zodiac').text( "Excuse me?")} 
                            if (m == 8 && d >=23 || m == 9 && d <=22) {$('#zodiac').text( "处女座")} 
                            if (m == 8 && d > 31) {$('#zodiac').text( "Yeah. Right.")} 
                            if (m == 9 && d >=23 || m == 10 && d <=22) {$('#zodiac').text( "天秤座")} 
                            if (m == 9 && d > 30) {$('#zodiac').text( "Try Again.")} 
                            if (m == 10 && d >=23 || m == 11 && d <=21) {$('#zodiac').text( "天蝎座")} 
                            if (m == 10 && d > 31) {$('#zodiac').text( "Forget it!")} 
                            if (m == 11 && d >=22 || m == 12 && d <=21) {$('#zodiac').text( "射手座")} 
                            if (m == 11 && d > 30) {$('#zodiac').text( "Invalid d")} 
                            if (m == 12 && d >=22 || m == 1 && d <=19) {$('#zodiac').text( "摩羯座")} 
                            if (m == 12 && d > 31) {$('#zodiac').text( "No way!")} 
                            ...
                            // 存储生日 
                            // var age =  $('#age').text();
                            var appDateTime = formatHeader(v);
                            localStorage.setItem("appDateTime", appDateTime);
                
                
                            // 存储 星座
                            var zodiac =  $('#zodiac').text()
                             localStorage.setItem("zodiac", zodiac);
                             // 取回
                             $("#zodiac").html(localStorage.getItem("zodiac"));
                             console.log($('#zodiac').text());
                
                             window.onload =function() {
                                 $("#age").html(localStorage.getItem("age"));
                                 $("#zodiac").html(localStorage.getItem("zodiac"));
                                 $("#birthday").html(localStorage.getItem("appDateTime"));
                                //  $("#birthday").html(localStorage.getItem("oldDate"));
                             }
        ...
        */
        that.show = function (prevAnim) {
            ...
            var html = '<div class="dw-trans ' + s.theme + ' dw-' + s.display + '">' + (s.display == 'inline' ? '<div class="dw dwbg dwi"><div class="dwwr">' : '<div class="dw-persp">' + '<div class="dwo"></div><div class="dw dwbg ' + mAnim + '"><div class="dw-arrw"><div class="dw-arrw-i"><div class="dw-arr"></div></div></div><div class="dwwr">' + (s.headerText ? '<div class="dwv" id="dwvTime"></div>' : ''));
            ...
            html += (s.display != 'inline' ? '<div class="dwbc' + (s.button3 ? ' dwbc-p' : '') + '"><span class="dwbw dwb-s" id="DetermineBtn"><span class="dwb" >' + s.setText + '</span></span>' + (s.button3 ? '<span class="dwbw dwb-n"><span class="dwb">' + s.button3Text + '</span></span>' : '') + '<span class="dwbw dwb-c"><span class="dwb">' + s.cancelText + '</span></span></div></div>' : '<div class="dwcc"></div>') + '</div></div></div>';
            dw = $(html);
